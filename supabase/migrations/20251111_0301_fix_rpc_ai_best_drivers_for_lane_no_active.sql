-- FILE: supabase/migrations/20251111_0301_fix_rpc_ai_best_drivers_for_lane_no_active.sql
-- Purpose: Drop any existing rpc_ai_best_drivers_for_lane overloads and recreate
--          it WITHOUT referencing drivers.is_active (since that column doesn't exist).
...
-- 2) Recreate the RPC (no is_active filter)
...
as $$
  /*
    ...
    FUTURE:
      - Make lane-aware by using driver_feedback.lane_key.
  */
  select
    d.id as driver_id,
