...
// IMPORTANT: create a SubtleCryptoProvider and pass it to constructEventAsync.
// This is exactly what Supabase's own Stripe webhook example does for Deno.
...
Deno.serve(async (req: Request): Promise<Response> => {
  ...
  try {
    // IMPORTANT: async verification with explicit SubtleCryptoProvider
